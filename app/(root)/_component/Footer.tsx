  ...
  return (
    <div className="w-full flex flex-col items-center justify-center space-y-2  h-[100px] sm:h-[100x] bg-black border-t border-stone-300">
      <div className="flex items-center justify-center w-[150px] h-[70.74px] mr-20 space-y-2 relative ">
        <div className="flex justify-center items-center w-[94.48px] h-[94.48px] left-[0px] top-[6px] absolute">
        ...
        <div className="flex justify-center items-center w-[94.48px] h-[94.48px] left-[155px] top-[6px] absolute">
      ...
      <div className=" text-white text-center sm:text-xs text-lg fontfont-normal font-roboto">
